...
import { Mail, Phone, MapPin, Facebook, Twitter, Instagram, ArrowRight, Linkedin } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/harit-eco-ventures/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="text-gray-500 dark:text-gray-400 hover:text-harit-500 dark:hover:text-harit-400 transition-colors">
                <Linkedin size={20} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@haritecoventures.com.np" className="text-gray-600 dark:text-gray-300 hover:text-harit-500 dark:hover:text-harit-400 transition-colors">info@haritecoventures.com.np</a>
              </li>
              <li className="flex items-start">
